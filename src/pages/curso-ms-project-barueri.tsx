      ...
      <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="container-xl relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="inline-block mb-5 px-4 py-2 rounded-full bg-blue-600/10 text-blue-400 text-sm font-semibold">
                Curso de MS Project em Barueri e Alphaville
              </span>

              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight text-white">
                Curso de MS Project em Barueri para Profissionais e Empresas
              </h1>

              <p className="text-lg mb-8 text-slate-300 leading-relaxed">
                Aprenda MS Project na prática com o Grupo Yto Nihon e desenvolva
                habilidades para planejar, controlar e acompanhar projetos com
                mais eficiência em Barueri, Alphaville e região.
              </p>
                ...
                <div className="aspect-[16/10] rounded-2xl bg-gradient-to-br from-blue-600/30 via-slate-800 to-slate-950 flex items-center justify-center text-center p-8">
                  <div>
                    <p className="text-blue-300 text-sm font-semibold mb-3">
                      MS PROJECT • CRONOGRAMAS • GESTÃO
                    </p>
                    <h2 className="text-3xl font-bold text-white mb-3">
                      Planeje e controle projetos com mais segurança
                    </h2>
                    <p className="text-slate-300">
                      Cronogramas, recursos, custos, prazos e acompanhamento.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16">
          <div className="container-xl max-w-5xl">
            <p className="mb-6">
              Se você procura um curso de MS Project em Barueri com foco prático,
              o Grupo Yto Nihon oferece uma formação voltada para profissionais
              que precisam organizar cronogramas, controlar prazos, gerenciar
              recursos e acompanhar projetos com mais clareza.
            </p>

            <p className="mb-6">
              Atendemos profissionais e empresas em Barueri, Alphaville, Osasco,
              Santana de Parnaíba e região, com treinamentos presenciais, online
              ao vivo e soluções corporativas personalizadas.
            </p>

            <p className="mb-6">
              O MS Project é uma das ferramentas mais utilizadas por profissionais
              de projetos, engenharia, obras, planejamento, manutenção, tecnologia
            ...
            <ul className="mb-6 space-y-2">
              ...
              <li>✔ Gestores e coordenadores de projetos</li>
              <li>✔ Profissionais de planejamento e obras</li>
              <li>✔ Analistas e líderes de equipes</li>
              <li>✔ Empresas que precisam treinar seus colaboradores</li>
              <li>✔ Profissionais que desejam melhorar a gestão de prazos e recursos</li>
            </ul>
            ...
            <ul className="mb-6 space-y-2">
              <li>✔ Criação de cronogramas no MS Project</li>
              <li>✔ Estruturação de tarefas e etapas do projeto</li>
              <li>✔ Vínculos entre atividades</li>
              <li>✔ Caminho crítico</li>
              <li>✔ Marcos do projeto</li>
              <li>✔ Cadastro e controle de recursos</li>
              <li>✔ Acompanhamento de prazos</li>
              <li>✔ Linha de base</li>
              <li>✔ Atualização do progresso do projeto</li>
              <li>✔ Relatórios e visão gerencial</li>
            </ul>

            <h2 className="text-2xl font-semibold mt-10 mb-4">
              MS Project para empresas em Barueri
            </h2>

            <p className="mb-6">
              Também oferecemos treinamento de MS Project para empresas em
              Barueri, Alphaville e região, com conteúdo adaptado à realidade
              da equipe e aos tipos de projetos desenvolvidos pela organização.
            </p>

            <p className="mb-6">
              O treinamento pode ser aplicado para equipes de engenharia,
              planejamento, obras, manutenção, tecnologia, operações e gestão
              corporativa.
            </p>
            ...
            <ul className="mb-6 space-y-2">
              ...
              <li>✔ Experiência prática com treinamentos profissionais</li>
              <li>✔ Metodologia aplicada ao mercado de trabalho</li>
              <li>✔ Forte atuação em Barueri, Alphaville e região</li>
            </ul>
...
export default CursoMSProjectBarueri;
