...
const differentials = [
  {
    ...
    description: 'Formação lato sensu com diploma reconhecido pelo Ministério da Educação, com validade em todo território nacional.',
  },
  {
    icon: Video,
    title: 'Aulas gravadas + encontros ao vivo',
    description: 'Flexibilidade para estudar no seu ritmo, com encontros ao vivo para revisão, orientação e aprofundamento.',
  },
  {
    icon: Users,
...
const targetAudience = [
  { title: 'Profissionais de TI', description: 'Desenvolvedores, analistas e profissionais técnicos que desejam especialização em dados.' },
  { title: 'Gestores e Executivos', description: 'Líderes que querem tomar decisões estratégicas baseadas em dados.' },
  { title: 'Analistas de Negócios', description: 'Profissionais que trabalham com análise e buscam aprofundamento técnico e estratégico.' },
  { title: 'Empreendedores', description: 'Empresários que desejam implementar cultura data-driven em seus negócios.' },
];
        ...
        <div className="container-xl relative z-10 text-center">
          ...
          >
            <span className="pill-badge-green pill-badge mb-8 inline-flex items-center gap-1.5">
              <Award className="w-3.5 h-3.5" /> Diploma reconhecido pelo MEC
            </span>
            ...
            <h2 className="text-gradient text-2xl md:text-3xl font-semibold mb-6">
              Formação premium em dados, tecnologia e decisões estratégicas
            </h2>

            <p className="hero-sub mx-auto mb-10 max-w-3xl">
              Desenvolva competências em análise de dados, engenharia, inteligência artificial e gestão estratégica
              para atuar em projetos reais e evoluir profissionalmente em um mercado cada vez mais orientado a dados.
            </p>
      ...
      <section className="section-pad" style={{ background: 'oklch(0.10 0.024 250)' }}>
        <div className="container-xl">
          ...
          >
            ...
            <h2 className="section-headline mb-4">Diferenciais da Pós-Graduação em Gestão Estratégica de Dados</h2>
            <p className="text-base max-w-2xl mx-auto" style={{ color: 'oklch(0.60 0.010 250)' }}>
              Uma formação desenvolvida para profissionais que desejam unir tecnologia, análise e visão estratégica de negócios.
            </p>
          </motion.div>
      ...
      <section className="section-pad" style={{ background: 'var(--brand-navy)' }}>
        <div className="container-xl">
          ...
          >
            ...
            <h2 className="section-headline mb-4">Grade curricular da Pós-Graduação em Dados</h2>
            <p className="text-base max-w-2xl mx-auto" style={{ color: 'oklch(0.60 0.010 250)' }}>
              Clique em cada disciplina para conhecer parte dos conteúdos abordados ao longo da formação.
            </p>
          </motion.div>
      ...
      <section className="section-pad" style={{ background: 'oklch(0.10 0.024 250)' }}>
        <div className="container-xl">
          ...
          >
            ...
            <h2 className="section-headline mb-4">Para quem é a pós-graduação em dados</h2>
          </motion.div>
        ...
        <div className="container-xl relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: 'oklch(0.93 0.006 250)', fontFamily: 'var(--font-heading)' }}>
              Comece sua evolução profissional em dados
            </h2>
            <p className="text-lg mb-8 max-w-2xl mx-auto" style={{ color: 'oklch(0.62 0.010 250)' }}>
              Fale com nossa equipe e entenda se esta pós-graduação é o próximo passo ideal para sua carreira.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
