          ...
          <div className="container-xl relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight text-white">
                Curso de Excel em Alphaville para Profissionais e Empresas
              </h1>

              <p className="text-lg mb-8 text-slate-300 leading-relaxed">
                Aprenda Excel na prática com o Grupo Yto Nihon, referência em treinamentos para profissionais e empresas em Alphaville, Barueri, Osasco e região.
              </p>
                ...
                <div className="aspect-[16/10] rounded-2xl bg-gradient-to-br from-blue-600/30 via-slate-800 to-slate-950 flex items-center justify-center text-center p-8">
                  <div>
                    <p className="text-blue-300 text-sm font-semibold mb-3">
                      EXCEL • DASHBOARDS • DADOS
                    </p>
                    <h2 className="text-3xl font-bold text-white mb-3">
                      Domine o Excel na prática
                    </h2>
  ...
  >
    Ver treinamentos para empresas
                    ...
                    <p className="text-slate-300">
                      Fórmulas, tabelas dinâmicas, relatórios e produtividade.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16">
          <div className="container-xl max-w-5xl">
            <p className="mb-6">
              Se você procura um curso de Excel em Alphaville com foco prático e aplicação no mercado de trabalho, aqui você encontra uma formação completa para evoluir profissionalmente.
            </p>
            ...
            <p className="mb-6">
              Veja também nosso curso de Power BI em Alphaville e amplie suas habilidades em análise de dados.
            </p>

            <a href="/curso-power-bi-alphaville" className="text-blue-500 underline">
              Ir para curso de Power BI em Alphaville
            </a>
            ...
            <h2 className="text-2xl font-semibold mt-10 mb-4">
              Curso de Excel para empresas em Alphaville
            </h2>

            <p className="mb-6">
              Também oferecemos treinamentos corporativos personalizados para empresas em Alphaville e região, com foco em produtividade e resultados reais.
            </p>

            <p className="mb-6">
              Se você está pesquisando por curso de Excel em Alphaville, aprender essa ferramenta pode abrir novas oportunidades profissionais e melhorar sua produtividade.
            </p>
            ...
            <a
              ...
              className="inline-block px-6 py-3 rounded-xl bg-blue-600 text-white font-semibold"
            >
              Quero aprender Excel em Alphaville
            </a>
          </div>
        </section>
      </div>
